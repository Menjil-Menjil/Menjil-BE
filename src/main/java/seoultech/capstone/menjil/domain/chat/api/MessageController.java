...
//    @SendTo("/queue/chat/{roomId}")
    public void enter(@DestinationVariable("roomId") String roomId,
        ...
        Object result = "";
        if (MessageType.QUESTION.equals(messageRequestDto.getMessageType())) {
            // 이 부분은 추후 비동기 처리 고려
            MessagesResponseDto responseDto = messageService.sendAIMessage(roomId, messageRequestDto);
            ...
            result = messageService.handleQuestion(roomId, messageRequestDto);
        }
    ...
    public Object messageTest(@RequestBody MessageRequestDto messageRequestDto) {
    ...
    public Object saveTest(@RequestBody MessageRequestDto messageRequestDto) {
