...
//public class ChatBotRoomServiceExceptionTest {
//
//    @InjectMocks
...
//        assertFalse(chatBotRoomService.deleteChatMessagesByRoomId(roomId));
//
...
//
//        // An exception is thrown, so the method should return false
//        assertFalse(chatBotRoomService.deleteChatBotRoomByRoomId(roomId));
//
//        // Verify that the repository method was called once
